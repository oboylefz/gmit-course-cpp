  #include "player.h"
    ...
    Player::Player(string forename, string surname, int mobileNumber, string position, string weight){
    ...
    void Player::printPlayerInfo(){
        cout<<"Name:"<<forename<<" "<<surname<<", DOB: "<<dob<<", position:"<<position<<", contact:"<<mobileNumber<<", weight: "<<weight<<endl;
    }
    ...
    void Player::setWeight(string weight){
        this->weight=weight;
    }
